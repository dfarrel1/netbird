...
type RelayConfig struct {
	...
	// tokenAuthAlgo selects the relay auth token format the client must
	// emit (goat ADR 1021). 0/unset and 1 = HMAC-SHA256 (unbound, legacy);
	// 2 = HMAC-SHA256 peer-ID-bound. Unset by old servers → client defaults
	// to unbound, preserving backward compatibility.
	TokenAuthAlgo uint32 `protobuf:"varint,4,opt,name=tokenAuthAlgo,proto3" json:"tokenAuthAlgo,omitempty"`
}
...
func (x *RelayConfig) GetTokenAuthAlgo() uint32 {
	if x != nil {
		return x.TokenAuthAlgo
	}
	return 0
}
...
var file_management_proto_rawDesc = []byte{
	...
	0x04, 0x44, 0x54, 0x4c, 0x53, 0x10, 0x04, 0x22, 0x93, 0x01, 0x0a, 0x0b, 0x52, 0x65, 0x6c, 0x61,
	...
	0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x24, 0x0a, 0x0d, 0x74, 0x6f, 0x6b, 0x65, 0x6e,
	0x41, 0x75, 0x74, 0x68, 0x41, 0x6c, 0x67, 0x6f, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0d,
	0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x41, 0x75, 0x74, 0x68, 0x41, 0x6c, 0x67, 0x6f, 0x22, 0xad, 0x02,
	...
	0x61, 0x69, 0x6c, 0x65, 0x64, 0x10, 0x02, 0x2a, 0x6c, 0x0a, 0x0e, 0x50, 0x65, 0x65, 0x72, 0x43,
	...
	0x6c, 0x61, 0x79, 0x10, 0x02, 0x2a, 0x4c, 0x0a, 0x0c, 0x52, 0x75, 0x6c, 0x65, 0x50, 0x72, 0x6f,
	...
	0x0a, 0x0a, 0x45, 0x58, 0x50, 0x4f, 0x53, 0x45, 0x5f, 0x54, 0x4c, 0x53, 0x10, 0x04, 0x32, 0xfd,
	0x06, 0x0a, 0x11, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x53, 0x65, 0x72,
	...
	0x2e, 0x45, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x65, 0x64, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x12, 0x4c, 0x0a, 0x0c, 0x43, 0x72, 0x65, 0x61, 0x74,
